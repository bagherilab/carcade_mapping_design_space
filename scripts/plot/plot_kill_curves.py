...
def plot_kill_curve_sim(simsDF, FILEID, SAVELOC, TIME):
    """Plot simulated kill curve data using CANCER LIVE % value."""
...
def plot_kill_curve_relative_sim(simsDF, FILEID, SAVELOC, TIME):
    """Plot simulated kill curve data where cells killed is calculated as 1-(living/living at treatment start)."""
...
def plot_kill_curve_exp(SAVELOC):
    """Plot kill curve of experimental literature data where all publications are on the same plot."""
...
def plot_kill_curve_exp_separated(SAVELOC):
    """Plot kill curve of experimental literature data where each publicaton is on a separate plot."""
...
def plot_kill_curve_normalized_exp(SAVELOC):
    """Plot kill curve of experimental literature data where lysed % and antigen value are normalized to max value and all publications are on the same plot."""
